...
from .utils.constants import CODERS_AT_WORK_PRODUCT_PAGE_LINK, MAIN_PAGE_LINK, THE_CITY_AND_THE_STARS_PRODUCT_PAGE_LINK
...
def test_guest_can_add_item_to_cart(browser):
    link = CODERS_AT_WORK_PRODUCT_PAGE_LINK
    page = ProductPage(browser, link)
    page.open()
    page.add_to_cart()

def test_guest_can_go_to_login_page_from_product_page(browser):
    link = THE_CITY_AND_THE_STARS_PRODUCT_PAGE_LINK
    page = ProductPage(browser, link)
    page.open()
